...
![Static Badge](https://img.shields.io/badge/20260401-UPDATE-brightgreen?style=plastic) 更新了网站架构：调整了`#2 评测数据`和`#4 评价标准`的内容。新增了[样例集20260401](sample%20sets/sample_20260401.json)。
...
# 6 评测赛程（暂定） 
- 2026年3-4月：评测任务发布（已完成）&参赛队伍报名（正在进行中）；
