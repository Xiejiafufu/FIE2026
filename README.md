...
![Static Badge](https://img.shields.io/badge/20260401-UPDATE-brightgreen?style=plastic) 更新了网站架构：更新了`#2 评测数据`和`#4 评价标准`的内容。新增了[样例集20260401](sample%20sets/sample_20260401.json)。
